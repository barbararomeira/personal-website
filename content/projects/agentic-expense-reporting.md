...
{{< project name="Agentic Expense Reporting System"
           ...
           tech="Python, Multi-agent AI, Mermaid, pytest"
           github="https://github.com/barbararomeira/agentic-expense-reporting-system" >}}
{{< step icon="📸" label="Receipt"            sub="photo capture" >}}
{{< step icon="🔍" label="Agent 1 · Extraction" sub="confidence gate" >}}
{{< step icon="🧮" label="Agent 2 · Compute"    sub="policy · VAT" >}}
{{< step icon="⚖️"  label="Agent 3 · Decision"   sub="approve / reject" >}}
{{< step icon="👥" label="Tiered Approval"     sub="1 or 2 approvers" >}}
