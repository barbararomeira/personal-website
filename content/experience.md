...
- Currently leading an LLM-powered chat feature that lets each customer build their own dashboards for their use case — no engineering involvement.
- Delivered multiple features end-to-end including Activity Recognition and the OEE module, working directly with backend, frontend, design, and computer vision teams.
- Drove a step-change in engagement: customers moved from project-based logins to 80%+ of accounts active daily.
